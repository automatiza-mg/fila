...
export const categoriasDiligencia: CategoriaDiligencia[] = [
  {
    ...
    subcategorias: [
      ...
      "Aposentadoria Voluntária: Requerimento de Aposentadoria / Aposentadoria por incapacidade permanente: Laudo Médico Oficial / Aposentadoria Compulsória: Cópia autenticada da certidão de nascimento ou casamento",
